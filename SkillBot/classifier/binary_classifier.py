...
class BinaryClassifier:
	...
	def __init__(self):
	    ...
	    self.mapping_class = ({"general": 1, "greeting": 0}) 
		# this are the labels of the classifier
		#the labels are general and greeting
	    self.training()
	    ...
	    for each_path in os.listdir(self.training_data_path):
	        with open(self.training_data_path+"/"+each_path) as fp:
	            ...
	            for each_line in data[:30]:
	                ...
	                y_train.append(each_path.rstrip(".txt"))
	...
	def training(self):
	    ...
	    clf = SVC(C=3, kernel="sigmoid", probability=True)
